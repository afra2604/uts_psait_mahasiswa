            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="allMahasiswa.php" class="btn btn-warning mr-3 pull-right"><i class="fa solid fa-user"></i> See All Data</a>
                    </div>
                    <div class="scroll">
                    <?php
                    $curl= curl_init();
                    ...
                    curl_setopt($curl, CURLOPT_URL, 'http://localhost/uts_psait/uts_mahasiswaApi.php');
                    $res = curl_exec($curl);
